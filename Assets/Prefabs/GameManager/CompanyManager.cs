...
public class CompanyManager : MonoBehaviour
{
    ...
    public enum trend { None, Western, Goth, Formal, Neon, Skater, Sporty, Cute, Graceful, Pirate, Southern, Fresh, Royal };
    [Header("choose 2 styles from 'It Wants'")]
    [Header("'It Wants': Styles the company likes for *THIS* game")]
    [Header("'It Likes': All possible styles a company likes")]
